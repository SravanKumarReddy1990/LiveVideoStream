package com.bsmaps.chatting.liveVideoBroadcaster;
...
import static com.bsmaps.chatting.MainActivity.RTMP_BASE_URL;
...
public class LiveVideoBroadcasterActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStreamNameEditText.setText(channelid);
